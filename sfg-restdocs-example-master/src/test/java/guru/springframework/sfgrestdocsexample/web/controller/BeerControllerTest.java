...
@AutoConfigureRestDocs(uriScheme = "https", uriHost = "dev.springframeworkHamza", uriPort = 80)
        ...
        mockMvc.perform(get("/api/v1/beer/{beerId}", UUID.randomUUID())
                ...
                .andDo(document("v1/beer",
                        ...
                        responseFields(
                                ...
                                fieldWithPath("upc").description("Price"),
                                fieldWithPath("price").description("Quantity On hand"),
        ...
        mockMvc.perform(post("/api/v1/beer/")
                ...
                .andDo(document("v1/beer",
                        requestFields(
                                ...
                                fields.withPath("upc").description("Beer UP").attributes(),
